...
class GetBookRecipesFromDbUseCase(private val bookRepository: BookRepository) {
    suspend operator fun invoke(): Either<RecipeManagerError, List<Recipe>> = bookRepository.getRecipesFromDb()
}